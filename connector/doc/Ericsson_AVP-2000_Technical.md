...
This is an HTTP connector for the Ericsson AVP-2000 Advanced Video Processor. With it, you can monitor the device, change its configuration where possible, and restore the configuration if necessary.
...
This connector has a **Web Interface** page that opens the web interface of the device.
...
The 3.1.1.1 range of the Ericsson AVP-2000 connector supports the usage of DCF. Only external connections are implemented.
