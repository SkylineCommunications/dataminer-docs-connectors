...
> [!IMPORTANT]
> This connector has been deprecated. [Bridge Technologies VB Probe Series](xref:Connector_help_Bridge_Technologies_VB_Probe_Series) should be used instead.
...
| **3.3.3.x**      | **Last Main Range** Fixed PKs on Streams tables. [Bridge Technologies VB Probe Series](xref:Connector_help_Bridge_Technologies_VB_Probe_Series) should be used instead.
                                                                                                               | **Yes**             | **Yes**                 |
