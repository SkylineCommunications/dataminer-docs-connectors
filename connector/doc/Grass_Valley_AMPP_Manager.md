...
- **Subscriptions:** Shows a table of existing subscriptions (Active, Historic, and Future), along with a child table listing the associated applications. The Subscriptions Applications table displays each application's name, quantity, and monthly token usage.
