---
uid: Connector_help_Pro-Bel_SW-P-08_Technical_2.1.X
---

# Pro-Bel SW-P-08 (2.1.X)
...
This range is intended for devices that do not support the extended command format for retrieving matrix labels, always using the short command format regardless of matrix size.
...
This range was created for devices that do not support the extended command format for retrieving matrix labels.

The **Matrix Number** and **Level Number** parameters must be set to a value of 15 or lower. Higher values are not supported in this range because the short command format cannot represent them.