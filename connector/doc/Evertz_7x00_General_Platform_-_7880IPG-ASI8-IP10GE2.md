...
> [!IMPORTANT]
> Two versions of this connector are registered, an SNMP version and an HTTP version. The SNMP version was never completed as the client abandoned this connector effort before it was finished. While most of the code has been written, it has not yet been reviewed in any way. As such, thorough testing with a 7880IPG-ASI-IP10GE2 encoder card is required before the SNMP version of this connector can be implemented.
