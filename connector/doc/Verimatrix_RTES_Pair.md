...
**Solution**: By setting up and using this connector, you can have data of both devices displayed at the same time so both monitoring and server preference can be provided for the current pair of devices. These can then be complemented by a redundancy solution of your choice, monitoring the current server preference dictated by the connector, to ensure seamless availability between your pair of encryption devices.
