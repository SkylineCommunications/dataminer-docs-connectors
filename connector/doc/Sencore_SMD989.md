...
- **System monitoring**: Monitor the reference clock, mute behavior, network settings, and more.
- **Input management**: Monitor and configure primary/backup input sources, failover conditions, and IP input settings.
- **Modulation control**: Configure modulation mode, symbol rate, spectral inversion, and more.
