...
| 4.0.2.x            | New Video Overview and Video Sessions pages with per-interface video QAM port, channel and input-port statistics and video session details.       | No              | Yes                 |
