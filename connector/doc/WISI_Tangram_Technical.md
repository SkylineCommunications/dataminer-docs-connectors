...
The visibility of the Module pages, containing specific information about the modules, can be set here as well, allowing for users to see information about the modules without needing to create DVEs for each module.
