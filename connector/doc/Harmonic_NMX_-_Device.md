...
This connector is exported by the [Harmonic NMX](xref:Connector_help_Harmonic_NMX) parent connector. A child element using this connector is automatically created for each device entry in the **Platform** table of the parent element, providing a dedicated view of that device's streams, services, alarms, and ports.
