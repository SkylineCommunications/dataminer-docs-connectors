...
Open-Meteo is a free and open API, so the connector will begin fetching weather data without any additional credentials. However, users with a commercial license can provide an API key on the **Element Settings** page.
