...
- **Ticket Retention Time**: Specifies how long (in seconds) a completed ticket remains in the Ticket Overview table before it is automatically removed. The default value is *3600*, i.e., 1 hour. Set this to *0* for *Real Time*, meaning that tickets are not retained after completion.
