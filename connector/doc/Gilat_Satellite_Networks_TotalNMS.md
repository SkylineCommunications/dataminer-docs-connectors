...
CPE DVEs will be created for devices for which the **DVE Enabled** parameter is set to **Enabled**. Also, for new CPE devices that are added to the table this parameter is set to **Disabled** by default, and this parameter setting can be changed in the **Settings** page.
...
The settings page also contains the section for CPE DVE creation. There are two settings user can change: 
- *Automatic CPE DVE Creation*
- *Enable/Disable All DVEs*

**Automatic CPE DVE Creation** is used to set the *DVE Enabled* for all future added CPE devices. By default is set to **Disabled**.
**Enable/Disable All DVEs** is used to set the state of all CPE devices in the table to **Enabled** or **Disabled**.
