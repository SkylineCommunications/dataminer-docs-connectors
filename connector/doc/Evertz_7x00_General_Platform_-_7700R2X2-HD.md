...
- **General**: Contains general information: **Card Type**, **Configuration Mode**, **Switch Mode**, etc.
- **Inputs**: Contains all the input information for both inputs: **Signal Presence**, **Total Bitrate**, etc.
- **Input 1 Alarms**: Contains information about input 1 alarming: **Video Invalid**, **Lost Signal**, etc.
- **Input 2 Alarms**: Contains information about input 2 alarming: **Video Invalid**, **Lost Signal**, etc.
- **De-Embedder**: Contains information about the **Input 1 & 2 Audio Groups**.
