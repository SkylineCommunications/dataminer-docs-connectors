...
This connector manages all the endpoints and ping statistics from the entire system and maintains relational information and aggregated data that can be viewed from a central frontend element and from the DataMiner Topology app.
...
Once the EPM Manager elements have been configured, the only necessary procedure is for the frontend element to import the MASTER_PING.csv file whenever there is a change to the file.
