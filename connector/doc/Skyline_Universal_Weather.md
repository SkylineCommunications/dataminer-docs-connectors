...
| 1.1.0.x [SLC Main] | OpenWeather OneCall 2.5, OpenWeather OneCall 3.0, and Windy point-forecast API v4 | 1.0.3.5 | Removed Dark Sky API endpoint from available options and WeatherAPI nuget. | 
