...
- **Switch inputs in one click**: Change the routed input straight from DataMiner, no need for separate control software.

- **Always know what's connected**: The current routing is kept up to date at all times, so you always know exactly what's active.
...
### Instant insight into what's routed
