...
**Benefit**: Reduces the physical hardware footprint and simplifies the transition to ST 2110 infrastructure.
...
**Challenge**: Synchronizing modern IP-based captioning data with legacy SDI encoders or older downstream devices.
...
- **Network connectivity** is required between the system and the Alta VM via HTTP (default port 80).
