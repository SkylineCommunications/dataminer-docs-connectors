...
This connector uses a virtual connection. The device connection is configured through the following parameters on the **General** page:
...
- **Connection Type**: The Rohde & Schwarz connection protocol used to reach the device. One of:
  - **VXI-11**
  - **Raw Socket** (default)
  - **HiSLIP**
