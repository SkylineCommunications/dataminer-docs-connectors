...
### IntelliGain Traps / AV Traps

These pages contain a table showing the **Fault Name**, **Send Trap control**, and **Fault Present** indication. This allows you to enable or disable traps for a given fault.

By setting **Send Trap** to *True*, you can enable traps for the given fault name. If the fault is present, it will be shown as *true* in the **Fault Present** column.
