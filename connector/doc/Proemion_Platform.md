...
- **Machine inventory**: Track all connected geothermal drilling machines — enriched with machine metadata — and their connection status with the Proemion Data Platform.

- **Geolocation tracking**: Monitor the physical location of machines, providing GPS-based insights into machine positioning to support fleet tracking, site operations, and logistics optimization.
...
**Benefit**: Enable proactive maintenance by identifying issues before failures occur, reduce unplanned downtime, and improve overall equipment reliability.
...
**Solution**: The connector allows you to group assets/machines logically into organizations.
