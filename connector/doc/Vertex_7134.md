...
The Vertex 7134 is an antenna control unit that supports **step tracking** and **memory tracking** to keep an antenna accurately aligned with its target.

This connector integrates the Vertex 7134 antenna control unit (ACU) into DataMiner, giving you a single interface to position, track, and monitor your antenna. You can position the antenna manually or recall a preset stored in the target and program tables, so you can move between known positions quickly and consistently.
