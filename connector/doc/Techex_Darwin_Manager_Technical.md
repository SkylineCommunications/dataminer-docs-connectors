...
The connector launches an interactive automation script to instantiate blueprints. For the blueprint instantiation feature to work, you need to install the [Techex Darwin Blueprint Instantiate](https://github.com/SkylineCommunications/SLC-AS-TechexDarwin) automation script on to the DataMiner system.
