...
The hidden **Debug page** was added. you can make this page visible again by enabling  the Debug_ShowDebugPage parameter using the multiple set feature. On the page you can enable the DEBUG_Asynchronouseventmessageshandlingmetrics parameter. This will enable the connector to write metrics about the asynchronous event messages in the element log file. We do advise to turn this option of when it is not needed.
