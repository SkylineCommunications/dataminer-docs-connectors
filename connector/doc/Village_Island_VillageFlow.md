...
On this page, you can enter the IP address of the VFMON server, to be able to access the **web interface**.

You can also enable or disable the **creation of XML files** here. If the creation of XML files is enabled, all XML files retrieved from the server software will be saved in the folder `C:\Skyline DataMiner\Documents\VillageFlow`.

### Web Interface page

If the IP address of the VFMON server software is provided on the Configuration page, it is possible to view the web interface in the DataMiner GUI.
