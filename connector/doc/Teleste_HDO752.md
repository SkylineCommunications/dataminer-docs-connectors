---
uid: Connector_help_Teleste_HDO752
---

# Teleste HDO752

The HDO752 is an optical amplifier. The **Teleste HDO752** connector can be used to display and configure information of the related device.
...
- **IP address/host**: The polling IP of the HDO752 device.
- **IP port**: The IP port of the HDO752 device.

### How to Use

The connector uses serial commands to request and push information to and from the node. This communication can be seen in the Stream Viewer.

The element using the HDO752 connector has a General, Monitoring, and Adjustment page.
