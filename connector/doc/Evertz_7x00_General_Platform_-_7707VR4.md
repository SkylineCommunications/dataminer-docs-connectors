...
- **General**: Contains general information such as **Output Standard on Loss**, the **Build version is 3** configuration, and the **Password** configuration.
- **Control**: Allows you to configure and monitor **Video** and **Optical**.
