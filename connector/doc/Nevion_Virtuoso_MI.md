...
| 1.0.2.x [SLC Main] | Added TS Input Switches. | 1.0.1.7 | Manual intervention is required in order to adapt existing DMS configurations, including DMS Filters, Automation Scripts, and Visio Files. |
