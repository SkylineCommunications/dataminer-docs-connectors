...
When you have created the element, configure the import file settings. If the **Import Directory File** parameter is set to *Remote*, you will have to specify the corresponding credentials under the **System Credentials** section, including the System Username and System Password fields.

## How to Use

### Configuration Page

On this page, you can define essential parameters for the connector.

In the **System Credentials** section, you will need to provide the credentials required for system-level access: **System Username** and **System Password**.

Additionally, you can specify an import folder to get the files generated from API responses or from the Nokia Altiplano Kafka element. This folder can be configured as either of the following:
...
- **Inbound Table**: Displays messages received by the element via InterApp communication.
