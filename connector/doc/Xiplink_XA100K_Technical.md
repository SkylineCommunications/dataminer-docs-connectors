...
No additional configuration is required after element creation. Once SNMP connectivity is established, the connector automatically retrieves all available telemetry data.
...
Provides SCPS and network connection performance metrics:
...
Provides CPU utilization trends:
...
Provides redundancy and failover-related parameters for high availability monitoring.
...
Provides access to the device web interface from DataMiner Cube.
