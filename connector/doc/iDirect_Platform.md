...
| 10.0.7.x [SLC Main] | Removed DisplayColumn feature.<br>DVE creation and polling have been separated, so all devices can now be polled without creating DVEs for all of them. | 10.0.6.21 | - **Trend and alarm history data will be lost**<br>- Backend cleanup but can be broken with old lingering data |
