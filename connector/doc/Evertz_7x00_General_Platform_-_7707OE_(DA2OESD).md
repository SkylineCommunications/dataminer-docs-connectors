...
This connector is used to monitor an Evertz 7707EO card, an optical-to-electrical converter.
...
This card returns DA2OESD as product name. VistaLink (Evertz NMS) uses a config packet name FIBEROE.
...
Its default name will be DA2OESD.x, where x is the slot where the card is attached.
