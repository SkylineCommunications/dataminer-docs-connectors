...
> [!NOTE]
> When you upgrade existing elements to range 1.0.1.x, you will need to reconfigure the alarm and trend templates for control sensors to take the subtables of each sensor type into account.
...
- **Control Sensors**: Contains information about all control sensors. The display key can be updated for each sensor.
- **Temperature/Sound/Humidity/Dew Sensors**: Contains information about each type of control sensors. More types of sensors may be added.
