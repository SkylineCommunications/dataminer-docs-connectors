...
The EVS XT Access connector provides monitoring of XT Access media processing operations. Broadcast operators can oversee media transfer jobs between EVS production servers and external systems from a single centralized interface.
