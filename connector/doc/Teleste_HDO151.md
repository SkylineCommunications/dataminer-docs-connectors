---
uid: Connector_help_Teleste_HDO151
---

# Teleste HDO151

The HDO151 is an optical switch. The **Teleste HDO151** connector can be used to display and configure information of the related device.
...
- **IP address/host**: The polling IP of the HDO151 device.
- **IP port**: The IP port of the HDO151 device.

### How to Use

The connector uses serial commands to request and push information to and from the node. This communication can be seen in the Stream Viewer.

The element using the HDO151 connector has a General, Monitoring, and Adjustment page.
